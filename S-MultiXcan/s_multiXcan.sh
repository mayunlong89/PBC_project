...
export OUTPUT=/share/pub/mayl/Sherlock/XiangbingYu_Primary_biliary_cholangitis/S_MultiXcan
export meta_data=/share/pub/mayl/Sherlock/XiangbingYu_Primary_biliary_cholangitis
...
#input file: PBC_GWAS_UKBiobank_summary_final
#output file:meta_GWAS_COVID19_4th_harmonized.txt
python $GWAS_TOOLS/gwas_parsing.py \
-gwas_file $meta_data/PBC_GWAS_UKBiobank_summary_final \
...
--insert_value sample_size 13239 --insert_value n_cases 2764 \
...
for db in `ls /share/home/mayl/miniconda3/DATABASE/sqtl/mashr/*db`; do
  ...
  --keep_non_rsid --additional_output --model_db_snp_key varID \
  --throw \
  --output_file $OUTPUT/spredixcan/sqtl/mashr/COVID_round_4th_GWAS_${db##*/}.csv
done
...
#input file: imputed_COVID_GWAS_round_4th.txt 
#output file:PBC_round_4th_GWAS_${db##*/}.csv
#----------------------------------------------------------------------
...
--verbosity 7 \
--throw \
--output $OUTPUT/smultixcan/eqtl/PBC_GWAS_round_4_mashr_smultixcan_eqtl.txt
...
--verbosity 7 \
--throw \
--output $OUTPUT/smultixcan/sqtl/PBC_GWAS_round_4_mashr_smultixcan_sqtl.txt
